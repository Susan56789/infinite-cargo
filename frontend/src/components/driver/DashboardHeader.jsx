            ...
            <div className="flex items-center space-x-2">
              ...
              >
                <span className={`inline-block h-3 w-3 transform rounded-full bg-white transition ${
                  user?.driverProfile?.isAvailable ? 'translate-x-5' : 'translate-x-1'
                }`} />
                {availabilityUpdating && (
                  <Loader className="absolute inset-0 h-2 w-2 m-auto animate-spin text-gray-600" />
                )}
              </button>
            </div>
